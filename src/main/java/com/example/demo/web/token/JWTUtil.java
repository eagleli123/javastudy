package com.example.demo.web.token;
...
/**
 * 2019年5月17日17:43:06 by: 巴西人
 */
@Slf4j
public class JWTUtil {

    public static void main(String[] args) {
        System.out.println("6xJQ4QnabssgPfaLsqfRWsdTasSRtWlsdN".length());
        String test = JWTUtil.createJWT(Long.MAX_VALUE, "laohu8", "test").split("\\.")[2].substring(9);
        String online = JWTUtil.createJWT(Long.MAX_VALUE, "laohu8", "online").split("\\.")[2].substring(9);
        String staging = JWTUtil.createJWT(Long.MAX_VALUE, "laohu8", "staging").split("\\.")[2].substring(9);
